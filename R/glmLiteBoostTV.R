...
predict.glmLiteBoostTV <- function(
  object,
  newdata = NULL,
  n.feat = NCOL(newdata),
  n.iter = NULL,
  ...
  if (inherits(object, "rtMod") && inherits(object$mod, "glmLiteBoostTV")) {
    ...
    if (verbose) msg2("Found glmLiteBoostTV object")
  } else {
...
expand.glmLiteBoostTV <- function(
  object,
  x,
  y = NULL,
  x.valid = NULL,
...
#' @keywords internal
#' @noRd
update.glmLiteBoostTV <- function(
  object,
  x = NULL,
  x.valid = NULL,
  trace = 0,
