...
#' XGBoost with linear booster (wrapper for \link{s_XGB})
#'
...
#' @inheritParams s_XGB
#' @param ... Additional arguments to be passed to \link{s_XGB}
#' @author E.D. Gennatas
#' @seealso \link{elevate} for external cross-validation
#' @family Supervised Learning
#' @export

s_XGBLIN <- function(x, y = NULL,
  ...
  s_XGB(x, y, x.test, y.test, booster = "gblinear",
        weights = weights,
        lambda = lambda,
