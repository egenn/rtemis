...
theme_rtemis_light <- function(base_size = 14,
  ...
  theme(line = element_line(colour = "black",
        ...
        axis.line.x = NULL,
        axis.line.y = NULL,
        axis.text = element_text(size = rel(axis.text.size.rel), # delta
                                 colour = "grey30"),
        ...
        legend.key = element_rect(fill = legend.key.fill, # delta
                                  colour = "white"),
        legend.key.size = unit(1.2, "lines"),
        legend.key.height = NULL,
        legend.key.width = NULL,
        legend.text = element_text(size = rel(legend.text.size.rel)), # delta
